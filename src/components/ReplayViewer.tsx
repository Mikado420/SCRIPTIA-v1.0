        ...
        <div className="lg:col-span-8 space-y-3">
          ...
          <div className="bg-stone-900/80 rounded-2xl p-3 border border-stone-800">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-1 text-rose-400 font-mono font-bold text-sm">
                ...
                <span>結界: {state.playerB.barrier} / 5</span>
              </div>
            </div>
          ...
          <div className="bg-stone-900/80 rounded-2xl p-3 border border-stone-800">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-1 text-rose-400 font-mono font-bold text-sm">
                <Shield className="w-4 h-4 text-rose-500 fill-rose-500" />
                <span>結界: {state.playerA.barrier} / 5</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-stone-900 border border-stone-800 rounded-2xl p-3 shadow-lg space-y-2">
            ...
            <div className="space-y-1 bg-stone-950 p-2.5 rounded-xl border border-stone-800 font-mono text-xs">
              <div className="text-stone-300">
                結界差分: P1({currentStep.diff.playerA_after.barrier - currentStep.diff.playerA_before.barrier >= 0 ? '+' : ''}
                {currentStep.diff.playerA_after.barrier - currentStep.diff.playerA_before.barrier}) / P2(
                {currentStep.diff.playerB_after.barrier - currentStep.diff.playerB_before.barrier >= 0 ? '+' : ''}
                {currentStep.diff.playerB_after.barrier - currentStep.diff.playerB_before.barrier})
              </div>
              <div className="text-stone-300">
